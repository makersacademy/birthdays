...
describe Birthday do
  describe "#age" do
    it "displays age of friend relative to today" do
      expect(subject.age({ birthday: "28/06/1984" })).to eq(35)
    end
  end
  describe "#birthday?" do
    it "outputs true if today is birthday" do
      expect(subject.birthday?({ birthday: "28/06/1984" })).to eq(true)
    end
  end
end
